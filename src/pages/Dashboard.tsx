...
const Dashboard = () => {
  ...
  const [openCreatePatientProfile, setOpenCreatePatientProfile] =
    useState(false);
  ...
  const [createdPatientUserId, setCreatedPatientUserId] = useState<
    number | null
  >(null);
  ...
  return (
    ...
    >
                      ...
                      <TableBody>
                        {staff.map((s) => (
                          <TableRow key={s.id}>
                            ...
                            <TableCell>
                              {getDepartmentName(s.department_id)}
                            </TableCell>
                            <TableCell align="center">
                              <Button
                                variant="outlined"
            ...
            <Grid size={{ xs: 12 }}>
              <Paper elevation={6} sx={{ p: 3, mb: 3 }}>
                ...
                >
                  ...
                  <Button
                    variant="contained"
                    onClick={() => setOpenCreatePatientUser(true)}
                  >
                    + Create Patient
                  </Button>
                </Box>
      ...
      {editingDept && (
        ...
        >
          <DialogTitle>
            {editingDept?.id === 0 ? "Add Department" : "Edit Department"}
          </DialogTitle>
          <DialogContent>
            <TextField
              label="Name"
      ...
      <Dialog
        open={openCreatePatientUser}
        onClose={() => setOpenCreatePatientUser(false)}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogActions>
          <Button onClick={() => setOpenCreatePatientUser(false)}>
            Cancel
          </Button>
          <Button
            variant="contained"
      ...
      <Dialog
        open={openCreatePatientProfile}
        onClose={() => setOpenCreatePatientProfile(false)}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogActions>
          <Button onClick={() => setOpenCreatePatientProfile(false)}>
            Cancel
          </Button>
          <Button
            variant="contained"
